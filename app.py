...
# ====================================
# Load Model and Vectorizer (with safety check)
# ====================================
def safe_load_pickle(filename):
    """Safely loads pickle file and prints debug info."""
    try:
...
if tfidf is None or model is None:
    print("Critical: vectorizer.pkl or model.pkl not found or unreadable.")
else:
